...
Route::middleware('auth')->group(function (): void {
    ...
    Route::post('/memories/bubbles/hide-grave', [MemoryController::class, 'hideGraveMode'])->name('memories.bubbles.hide-grave');
    Route::post('/memories/bubbles/store-grave', [MemoryController::class, 'storeGraveMemory'])->name('memories.bubbles.store-grave');
